...
const App = () => {
    ...
    return (
        <>
            {isModalVisible && (
                <div className={`auth-modal ${isModalVisible ? 'show' : ''}`}>
                    <div className={`container ${isRegister ? 'active' : ''}`}>
                            ...
                            <form method="POST" action={"/login"}>
                                ...
                                <div className="login-button-container">
                                    ...
                                    >
                                        <img
                                            loading="lazy"
                                            src="assets/svg/icons/gg_google.svg"
                                            alt=""
                                        />
                                        Login With Google
                                    </a>
                                    <button className="facebook-login">
                                        <img
                                            loading="lazy"
                                            src="assets/svg/icons/ic_baseline-facebook.svg"
                                            alt=""
                                        />
                                    </button>
                                    <button className="linkedin-login">
                                        <img
                                            loading="lazy"
                                            src="assets/svg/icons/mdi_linkedin.svg"
                                            alt=""
                                        />
                                    </button>
                                </div>
                                <div className="form-check ml-0 mt-1 mb-2 text-left align-items-center d-flex mt-4">
                                    <input
                        ...
                        <div className="form-box register">
                            <form>
                                <h3 style={{ fontWeight: "500" }}>Log in To Clocker</h3>

                                <div className="form-check mt-4 mb-3">
                                    <label className="form-check-label" htmlFor="option1">
                                        <div className="card" id="card-option1">
                                            <div className="card-body">
                                                ...
                                                <p
                                                    className="card-text text-left mb-0 mt-1"
                                                    style={{ fontSize: "18px", fontWeight: "400" }}
                                                >
                                                    Im a freelancer and worker looking
                                                    for job
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="form-check mb-3">
                                    <label className="form-check-label" htmlFor="option2">
                                        <div className="card" id="card-option2">
                                            <div className="card-body">
                                                <div className="justify-content-between d-flex">
                                                    <svg
                                                        width="30"
                                                ...
                                                <p
                                                    ...
                                                    style={{ fontSize: "18px", fontWeight: "400" }}
                                                >
                                                    Im a client looking for a freelancer
                                                </p>
                                            </div>
                                        </div>
                                    </label>
                                ...
                                <div className="form-check mb-3">
                                    <label className="form-check-label" htmlFor="option3">
                                        <div className="card" id="card-option3">
                                            <div className="card-body">
                                                <div className="justify-content-between d-flex">
                                                    <svg
                                                        width="34"
                                                ...
                                                <p
                                                    ...
                                                    style={{ fontSize: "18px", fontWeight: "400" }}
                                                >
                                                    I have a company and I'm looking for
                                                    a worker
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <button
                                    type="button"
                                    id="login-button"
                                    className="btn btn-login mt-3 mb-2"
                                    disabled
                                >
                                    Create Account
                                </button>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <span className="mx-2 text-line">
                                        Already have an Clocker account?{" "}
                                        <a href="" className="text-landing">
                                            Log in
                                        </a>
                                    </span>
                                    <hr className="flex-grow-1 thick-line" />
                        ...
                        <div className="toggle-box">
                            <img
                                loading="lazy"
                                src="assets/images/4ec9514b66c366d84e143a15f119c010.png"
                                alt=""
                                className="logo"
                            />
                            <div className="toggle-panel toggle-left">
                                <h1>Welcome Back</h1>
                                <p>
                                    Hi, nice to see you back and stay connected with us.
                                </p>
                                <button className="btn register-btn text-white" onClick={() => setIsRegister(true)}>
                                    Sign Up
                                </button>
                                <img
                                    loading="lazy"
                                    src="assets_landing/images/login1.png"
                                    alt="login1"
                                    className="login1"
                                />
                                <img
                                    loading="lazy"
                                    src="assets_landing/images/login2.png"
                                    alt="login2"
                                    className="login2"
                                />
                            </div>
                            ...
                            <div className="toggle-panel toggle-right">
                                <h1>Welcome Back!</h1>
                                <p>
                                    Start your journey in building your career with us
                                    at Clocker.
                                </p>
                                <button className="btn login-btn text-white" onClick={() => setIsRegister(false)}>Login</button>
                                <img
                                    loading="lazy"
                                    src="assets_landing/images/login1.png"
                                    alt="login1"
...
ReactDOM.createRoot(document.getElementById("auth")).render(<App />);
