    ...
    <div class="main-page best-selling" data-select2-id="9">
        <div class="view_slider recommended pt-5" data-select2-id="8">
            <div class="container" data-select2-id="7">
                <div class="sorting-div d-flex align-items-center justify-content-between" data-select2-id="6">
                    <p class="mb-2">463 favorite</p>
                    <div class="sorting d-flex align-items-center" data-select2-id="5">
                        <p>Sort</p>
                        <select class="custom-select custom-select-sm border-0 shadow-sm ml-2 select2-hidden-accessible"
                            data-select2-id="1" tabindex="-1" aria-hidden="true">
                            <option data-select2-id="3">Newest saved</option>
                            <option data-select2-id="11">Oldest saved</option>
                        </select>
                    </div>
                </div>
                <h3>All Favorites</h3>
