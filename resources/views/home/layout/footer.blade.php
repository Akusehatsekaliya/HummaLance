<footer class="bg-white">
    ...
    <div class="copyright" style="background-color: black;">
        ...
        <ul class="social" style="margin-right: 10rem;">
            ...
            <li>
                <a href="#" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.70rem" height="2.1rem" viewBox="0 0 24 24" style="color: #ffffff;">
            ...
            <li>
                <a href="#" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.86rem" height="2.10rem" viewBox="0 0 24 24" style="color: #ffffff;">
            ...
            <li>
                <a href="#" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.1rem" height="2.1rem" viewBox="0 0 24 24" style="color: #ffffff;">
            ...
            <li>
                <a href="#" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2.1rem" viewBox="0 0 24 24" style="color: #ffffff; margin-left: 0.5rem;">
            ...
            <li>
                <a href="#" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2.1rem" viewBox="0 0 24 24" style="color: #ffffff; margin-left: 5rem;">
                ...
                <span style="margin-left: 5.50rem; color: #ffffff">Indonesia</span>
            </li>
        </ul>
    </div>
</footer>
