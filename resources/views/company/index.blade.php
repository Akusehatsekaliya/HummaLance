                            ...
                            <div id="accordion">
                                    ...
                                    <div id="collapsetwo" class="collapse show" aria-labelledby="headingTwo"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="cb6">Full Website Creation
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                ...
                                <div class="filters-card p-4 border-bottom">
                                    ...
                                    <div id="collapseOffer" class="collapse" aria-labelledby="headingOffer"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="cb6">
                                                <label class="custom-control-label" for="cb6">Top Rated Seller <small
                                                        class="text-danger float-right">80</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="cb7">
                                                <label class="custom-control-label" for="cb7">Level One <small
                                                        class="text-danger float-right">34</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="cb8">
                                                <label class="custom-control-label" for="cb8">Level Two <small
                                                        class="text-danger float-right">56</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="cb9">
                                                <label class="custom-control-label" for="cb9">New Seller <small
                                                        class="text-danger float-right">98</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="cb10">
                                                <label class="custom-control-label" for="cb10"> Seller <small
                                                        class="text-danger float-right">21</small></label>
                                            </div>
                                            <div class="mt-2"><a href="#" class="link">See all</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="filters-card p-4">
                                    <div class="filters-card-header" id="headingDistance">
                                        <h6 class="mb-0">
                                            <a href="#" class="btn-link" data-toggle="collapse"
                                                data-target="#collapseDistance" aria-expanded="true"
                                                aria-controls="collapseDistance">
                                                Pro Services <i class="mdi mdi-chevron-down float-right"></i>
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapseDistance" class="collapse show" aria-labelledby="headingDistance"
                                        data-parent="#accordion">
                                        <div class="filters-card-body card-shop-filters">
