            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-10 py-4">
                    <div class="justify-content-between d-flex">
                        ...
                        <p class="text-landing">Join as a freelancer <span class="text-body-2">or</span> Join as a company</p>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="card-register">
                        ...
                        <form action="">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                <label for="inputfisrt" class="form-label">First Name</label>
                                ...
                                <div class="form-check mt-1 mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Yes, I understand and agree to the <span class="text-landing">Clocker Terms of Service</span> , including the <span class="text-landing">User Agreement</span> <br> and <span class="text-landing">Privacy Policy</span>.
                                    </label>
                                </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center my-3">
                            <hr class="flex-grow-1 thick-line">
                            <span class="mx-2 text-body-2">Already have an Clocker account? <span class="text-landing">Log in</span></span>
                            <hr class="flex-grow-1 thick-line">
                        </div>
                    </div>
                </div>
