...
<div class="px-5 justify-content-center d-flex">
    <div class="col-lg-5 right-section justify-content-center d-flex">
        <div class="image-container">
            <img alt="Illustration of a person working on a laptop" height="400" src="http://127.0.0.1:8000/assets_landing/images/adventure.png">
        </div>
    </div>
