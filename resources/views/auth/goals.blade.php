...
@endsection
@section('content')
    <div class="col-lg-5 text-start pl-5">
        ...
        <p style="width: 26rem;font-size: 15px;">Many people come to clocker with a variety of goals and achievements they want to achieve, we want to highlight
            opportunities that match your biggest goals.</p>
        <ul class="text-landing" style="font-size:15px;">
            <li class="my-3">
                <svg class="mr-2" width="25" height="25" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2259_1716)">
                    <path d="M13.4346 13.4336C12.8846 13.9807 12.5742 14.7237 12.5713 15.4994C12.5713 16.2763 12.8799 17.0213 13.4292 17.5707C13.9785 18.12 14.7236 18.4286 15.5005 18.4286C16.2762 18.4257 17.0192 18.1152 17.5663 17.5653" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M15.5004 6.71191C13.7624 6.71191 12.0634 7.22729 10.6183 8.19287C9.17322 9.15846 8.04691 10.5309 7.3818 12.1366C6.7167 13.7423 6.54268 15.5092 6.88174 17.2138C7.22081 18.9184 8.05774 20.4842 9.28669 21.7131C10.5156 22.9421 12.0814 23.779 13.786 24.1181C15.4906 24.4571 17.2575 24.2831 18.8632 23.618C20.4689 22.9529 21.8414 21.8266 22.8069 20.3815C23.7725 18.9364 24.2879 17.2374 24.2879 15.4994" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M15.5003 0.853516C12.6037 0.853516 9.77204 1.71248 7.36354 3.32178C4.95505 4.93109 3.07786 7.21846 1.96935 9.89463C0.860838 12.5708 0.570802 15.5156 1.13591 18.3566C1.70103 21.1976 3.09591 23.8073 5.14416 25.8555C7.19242 27.9038 9.80206 29.2987 12.6431 29.8638C15.4841 30.4289 18.4289 30.1388 21.105 29.0303C23.7812 27.9218 26.0686 26.0446 27.6779 23.6361C29.2872 21.2276 30.1462 18.396 30.1462 15.4993M20.9347 10.0665L16.9649 14.0348" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M29.2832 6.00929L24.2882 6.71229L24.9912 1.71729C24.9964 1.65927 24.9841 1.60103 24.956 1.55002C24.9279 1.499 24.8852 1.45752 24.8334 1.43088C24.7816 1.40423 24.7231 1.39364 24.6652 1.40044C24.6074 1.40725 24.5529 1.43115 24.5087 1.46908L21.1972 4.76362C20.857 5.10621 20.6068 5.52756 20.4689 5.99018C20.3309 6.4528 20.3094 6.94236 20.4063 7.41529L20.9335 10.067L23.5852 10.5927C24.0581 10.6896 24.5477 10.6681 25.0103 10.5301C25.4729 10.3921 25.8943 10.1419 26.2369 9.80179L29.5299 6.49183C29.5679 6.44754 29.5919 6.39287 29.5987 6.33486C29.6054 6.27685 29.5947 6.21813 29.5679 6.16626C29.541 6.11439 29.4993 6.07173 29.448 6.04376C29.3967 6.01579 29.3383 6.00378 29.2801 6.00929" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
            ...
            <li class="mb-3">
                <svg class="mr-2" width="25" height="27" viewBox="0 0 32 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2259_1726)">
                    <path d="M8.60293 21.3877C8.22324 21.3877 7.91387 21.6971 7.91387 22.0768V32.5674H2.7248V22.1049C2.7248 21.7252 2.41543 21.4158 2.03574 21.4158C1.65605 21.4158 1.34668 21.7252 1.34668 22.1049V33.2705C1.34668 33.6502 1.65605 33.9596 2.03574 33.9596H8.60293C8.98262 33.9596 9.29199 33.6502 9.29199 33.2705V22.0908C9.29199 21.6971 8.98262 21.3877 8.60293 21.3877Z" fill="#00AAFF"/>
                    <path d="M19.2764 18.7158C18.8967 18.7158 18.5873 19.0252 18.5873 19.4049V32.5674H13.4123V21.4721C13.4123 21.0924 13.1029 20.783 12.7232 20.783C12.3436 20.783 12.0342 21.0924 12.0342 21.4721V33.2564C12.0342 33.6361 12.3436 33.9455 12.7232 33.9455H19.2904C19.6701 33.9455 19.9795 33.6361 19.9795 33.2564V19.4049C19.9795 19.0252 19.6701 18.7158 19.2764 18.7158Z" fill="#00AAFF"/>
                    <path d="M29.9779 12.3457C29.5982 12.3457 29.2889 12.6551 29.2889 13.0348V32.5676H24.0998V17.127C24.0998 16.7473 23.7904 16.4379 23.4107 16.4379C23.0311 16.4379 22.7217 16.7473 22.7217 17.127V33.2566C22.7217 33.6363 23.0311 33.9457 23.4107 33.9457H29.9779C30.3576 33.9457 30.667 33.6363 30.667 33.2566V13.0488C30.667 12.6551 30.3576 12.3457 29.9779 12.3457Z" fill="#00AAFF"/>
                    <path d="M31.0327 0.687695C31.0186 0.43457 30.8639 0.223633 30.653 0.111133C30.428 -0.00136717 30.1608 0.0126953 29.9639 0.15332L22.3983 5.1877C22.1874 5.32832 22.0749 5.56738 22.0889 5.80645C22.103 6.05957 22.2577 6.27051 22.4686 6.38301L25.8436 8.05645C22.2577 16.0158 10.5858 19.0955 1.14989 17.9283C0.770199 17.8721 0.418637 18.1533 0.376449 18.533C0.334262 18.9127 0.60145 19.2643 0.981137 19.3064C2.37332 19.4752 3.79364 19.5596 5.24207 19.5596C14.2983 19.5596 23.7343 16.1002 27.0952 8.66113L30.6249 10.4189C30.7233 10.4611 30.8218 10.4893 30.9343 10.4893C31.0749 10.4893 31.2014 10.4471 31.3139 10.3768C31.5249 10.2361 31.6374 9.99707 31.6233 9.75801L31.0327 0.687695ZM27.0108 7.08613C26.9968 7.07207 26.9968 7.08613 27.0108 7.08613C26.9968 7.07207 26.9968 7.07207 26.9968 7.07207L24.1843 5.67988L29.7389 1.98145L30.1749 8.64707L27.0108 7.08613Z" fill="#00AAFF"/>
                    </g>
                    <defs>
    ...
    <div class="col-lg-5 grid-goals px-4 pb-3 pt-3 mt-3">
        ...
        display: contents;">
            ...
            <label class="card-option-container" for="goal1">
                ...
                <img src="{{ asset('assets/svg/register/Coins-amico.svg') }}" alt="icon" style="width: 142px;height: 124px;">
                <br>
            ...
            <label class="card-option-container " data-color="#000" for="goal3">
                ...
                <br>
                <span>I want to gain experience</span>
            </label>
            {{-- </div> --}}
            ...
            <label class="card-option-container" for="goal4">
                ...
                <br>
                <span>I don't have any <br> goals yet</span>
            </label>
            {{-- </div> --}}
    </div>
