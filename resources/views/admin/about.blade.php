            ...
            <div class="card-content">
              <div class="card-body">
                @foreach ($abouts as $about)
                  <form action="{{ route('admin.about.update', $about->id) }}" method="POST" class="form form-vertical"
                          ...
                          <div class="logo-wrapper">
                            <div class="logo-upload mt-5 mb-5">
                              <div class="image-preview-container" id="avatar-preview-container">
                                <img src="{{ asset("storage/$about->image") }}" alt="up" class="upload-img"
                                  id="upload-img" style="object-fit: cover;">
