...
<head>
    ...
    <!-- Select2 CSS -->
    <link href="{{ asset('assets_landing/vendor/select2/css/select2-bootstrap.css') }}" />
...
<body>
    ...
    <script src="{{ asset('assets_landing/vendor/jquery/jquery.min.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/vendor/bootstrap/js/bootstrap.bundle.min.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/js/jqBootstrapValidation.html') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/js/contact_me.html') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/vendor/slick-master/slick/slick.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript" charset="utf-8"></script>
    <script src="{{ asset('assets_landing/vendor/lightgallery-master/dist/js/lightgallery-all.min.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/vendor/select2/js/select2.min.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
    <script src="{{ asset('assets_landing/js/custom.js') }}" type="643b16316ea0a7fbc48d654c-text/javascript"></script>
