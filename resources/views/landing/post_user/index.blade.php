        ...
        <div class="row freelance-slider">
            <div class="col">
                ...
                <div class="freelancer">
                    ...
                    <p style="text-align: left; padding-left: 10px; font-weight: 500; margin-top: -12px;">I Will Make You
                        A Great Logo Design, With Modern And Minimalist Style</p>
                    <div class="content-info" style="padding-left: 10px;">
                        <div class="rating-wrapper">
                            <span class="gig-rating text-body-2">
                                ...
                                <span style="font-weight: bold">5.0 </span>(555)
                            </span>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
