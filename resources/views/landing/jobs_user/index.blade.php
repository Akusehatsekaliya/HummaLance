                    ...
                    <div class="view recent-slider recommended-slider slick-initialized slick-slider"><button
                        ...
                        <div class="slick-list draggable">
                            <div class="slick-track"
                                style="opacity: 1; width: 4560px; transform: translate3d(-1140px, 0px, 0px);">
                                <div class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true"
                                    tabindex="-1" style="width: 255px;">
                                    <div>
                                                ...
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s3.png"
                                                                alt="">
                                                        </span>
                                                    ...
                                                    <h3>I will create professional audio ads or radio commercials for
                                                        your project</h3>
                                        ...
                                        <div style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="inner-slider">
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s4.png"
                                                                alt="">
                                                        </span>
                                                        <span class="seller-name">
                                                            <a href="profile.html" tabindex="-1">Marcin Kowalski</a>
                                        ...
                                        <div style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="inner-slider">
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s5.png"
                                                                alt="">
                                                        </span>
                                                        <span class="seller-name">
                                                            <a href="profile.html" tabindex="-1">Marcin Kowalski</a>
                                        ...
                                        <div style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="inner-slider">
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s6.png"
                                                                alt="">
                                                        </span>
                                                        <span class="seller-name">
                                                            <a href="profile.html" tabindex="-1">Marcin Kowalski</a>
                                ...
                                <div class="slick-slide slick-current slick-active" data-slick-index="0"
                                    aria-hidden="false" style="width: 255px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="inner-slider">
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s1.png"
                                                                alt="">
                                                        </span>
                                                        <span class="seller-name">
                                        ...
                                        <div style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="inner-slider">
                                                <div class="inner-wrapper">
                                                    <div class="d-flex align-items-center">
                                                        <span class="seller-image">
                                                            <img class="img-fluid" src="images/user/s2.png"
                                                                alt="">
                                                        </span>
                                                        <span class="seller-name">
                                                            <a href="profile.html" tabindex="0">Marcin Kowalski</a>
                            ...
                            fdprocessedid="f3wa8fd">Next</button>
                    </div>
                </div>
            </div>
        </div>
