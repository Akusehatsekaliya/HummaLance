        ...
        <div class="col-lg-8 left">
          ...
          <div class="profile-card">
            ...
            <div id="recommendations" class="recommended">
              ...
              <div class="recommended-slider recommend slick-initialized slick-slider"><button
                  class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
                <div class="slick-list draggable">
                  <div class="slick-track" style="opacity: 1; width: 3040px; transform: translate3d(-760px, 0px, 0px);">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              ...
              <select class="custom-select custom-select-sm border-0 shadow-sm ml-2 select2-hidden-accessible"
                ...
                data-select2-id="2" style="width: 188px;"><span class="selection"><span
                    ...
                    aria-expanded="false" tabindex="0" aria-labelledby="select2-dg20-container"><span
                      class="select2-selection__rendered" id="select2-dg20-container" role="textbox"
