<nav class="navbar navbar-expand-lg navbar-light topbar static-top bg-landing osahan-nav-top px-0">
    <div class="container">
        ...
        <div class="collapse navbar-collapse nav-links" id="navLinks">
            <ul class="navbar-nav ml-auto mr-sm-auto">
                ...
                <li @class(['nav-item', 'active' => request()->routeIs('landing.events')])>
                    <a class="nav-landing" href="{{ route('landing.events') }}">Events</a>
                </li>

                <li>
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2.1rem" viewBox="0 0 24 24"
                            style="color: #ffffff; margin-left: 2rem;">
...
{{-- <div class="offcanvas offcanvas-start bg-landing osahan-nav-top px-0" tabindex="-1" id="sidebarMenu"
