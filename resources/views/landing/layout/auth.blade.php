              ...
              <label class="form-check-label" for="option1">
                <div class="card" id="card-option1">
                    <div class="card-body">
                        ...
                        <p class="card-text text-left mb-0 mt-1" style="font-size: 18px; font-weight:500;">Im a freelancer looking for client</p>
                    </div>
                </div>
            </label>
        </div>
                ...
                <div class="card" id="card-option2">
                    <div class="card-body">
                      <div class="justify-content-between d-flex">
                        ...
                        <p class="card-text text-left mb-0 mt-1" style="font-size: 18px; font-weight:500;">Im a job seeker looking for a work</p>
                    </div>
                </div>
            </label>
        </div>
                ...
                <div class="card" id="card-option3">
                    <div class="card-body">
                      <div class="justify-content-between d-flex">
                        ...
                        <p class="card-text text-left mb-0 mt-1" style="font-size: 18px; font-weight:500;">I have a company and I'm looking for a worker</p>
                    </div>
                </div>
            </label>
        </div>
