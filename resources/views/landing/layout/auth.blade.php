    ...
    <div class="auth-modal">
        <div class="container">
            ...
            <div class="form-box login">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" class="@error('email') is-invalid @enderror" placeholder="Password"
                    ...
                    <div class="login-button-container">
                        ...
                        <button class="facebook-login">
                            <img loading="lazy" src="{{ asset('assets/svg/icons/ic_baseline-facebook.svg') }}"
                                alt="" />
                        </button>
                        ...
                        <label class="form-check-label" for="option2">
                            <div class="card" id="card-option2">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-left mb-0 mt-1" style="font-size: 18px; font-weight:400;">Im
                                        a client looking for a freelancer</p>
                                </div>
                            </div>
                        </label>
                    </div>
                        ...
                        <label class="form-check-label" for="option3">
                            <div class="card" id="card-option3">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-left mb-0 mt-1" style="font-size: 18px; font-weight:400;">I
                                        have a company and I'm looking for a worker</p>
                                </div>
                            </div>
                        </label>
                    </div>

                    <button type="button" id="login-button" class="btn btn-login mt-3 mb-2" disabled>Create
                        Account</button>

                    <div class="d-flex align-items-center">
                        <hr class="flex-grow-1 thick-line">
                        <span class="mx-2 text-line">Already have an Clocker account? <a href=""
                                class="text-landing">Log in</a></span>
                        <hr class="flex-grow-1 thick-line">
                    </div>
            ...
            <div class="toggle-box">
                <img loading="lazy" src="{{ asset('assets/images/4ec9514b66c366d84e143a15f119c010.png') }}"
                    alt="" class="logo">
                <div class="toggle-panel toggle-left">
                    <h1>Welcome Back</h1>
                    <p>Hi, nice to see you back and stay connected with us.</p>
                    <button class="btn register-btn text-white">Sign Up</button>
                    <img loading="lazy" src="{{ asset('assets_landing/images/login1.png') }}" alt="login1"
                        class="login1">
                    <img loading="lazy" src="{{ asset('assets_landing/images/login2.png') }}" alt="login2"
                        class="login2">
                </div>
            ...
            radios.forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    if (document.querySelector('input[name="option"]:checked')) {
                        const selectedValue = document.querySelector('input[name="option"]:checked')
                            .value;
