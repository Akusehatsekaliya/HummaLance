<div id="main">
  ...
  <nav class="navbar navbar-expand-lg shadow-sm ms-auto p-0">
    <div class="container-fluid">
      ...
      <button class="navbar-toggler sidebar-hide" style="height: fit-content;margin-top: 10px;"{{-- type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent"
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown"
              ...
              <div class="avatar avatar-online position-relative">
                <img src="{{ auth()->user()->getAvatar(asset('avatar.jpg')) }}" alt="User Avatar" class="rounded-circle"
