    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('icon.png') }}" alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.contract.*') ? 'active' : '' }} ">
                    <a href="{{ route('admin.contract.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.language.*') ? 'active' : '' }} ">
